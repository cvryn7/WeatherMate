...
import com.example.cv.weathermate.data.WeatherContract.WeatherEntry;
...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        Cursor locationData = mContext.getContentResolver().query(
                WeatherContract.LocationEntry.CONTENT_URI,//uri
                null,//projection/column names
                WeatherContract.LocationEntry.COLUMN_CITY_NAME+"= ?",//selection
                new String[]{cityName},//selection arguments
                null//sort order
        );

        if( locationData.getCount() == 1 ){
            locationData.moveToFirst();
            int columnIndex = locationData.getColumnIndex(WeatherContract.LocationEntry._ID);
            return locationData.getLong(columnIndex);
        }
    ...
    protected String[] doInBackground(String... params) {
        ...
        String units = "metric";
        int numDays = 14;
        String apiId = "cf13dda10d2a8dc3d102fd4ca5a2f412";
        try {
            ...
            Uri builtUri = Uri.parse(FORECAST_BASE_URL).buildUpon()
                    ...
                    .appendQueryParameter(API_ID,apiId)
                    .build();
